 ...
 *   Any additional params to be added to the request.
 * @param {Function} fn
 *   The callback. This will receive two parameters: fn(Error e, Array listOfContainers).
 */
Compute.prototype.servers = function (limit, marker, params, fn) {

  // Handle optional params.
  var a = Futil.argsWithFn(arguments, ['limit', 'marker', 'params', 'fn'])
  limit = a.limit;
  marker = a.marker;
  fn = a.fn;
  ...
  var params = qs.stringify(a.params || {});
  if (params) {
    url += '&' + params;
  }
 ...
 *
 * @param {int} limit (Optional)
 *   The maximum number of images to be returned.
 * @param {String} marker (Optional)
 *   The name of the last entry received.
 * @param {Object} params (Optional)
 *   Any additional params to be added to the request.
 ...
 *    fn(Error e, Array listOfImages).
 */
Compute.prototype.images = function (limit, marker, params, fn) {
  ...
  var url = this.url() + '/images/detail?format=json';
  if (a.limit) {
    url += '&limit=' + encodeURIComponent(a.limit);
  }
  if (a.marker) {
